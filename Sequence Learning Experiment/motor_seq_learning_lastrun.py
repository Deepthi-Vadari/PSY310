...
expName = 'motor_seq_learning'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Srikanth Vadari\\Documents\\AU_mycourses\\TY\\PSY310(L)\\Motor_seqlearn\\motor_seq_learning_lastrun.py',
