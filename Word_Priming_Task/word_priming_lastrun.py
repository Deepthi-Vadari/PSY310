...
expName = 'word_priming'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Srikanth Vadari\\Documents\\AU_mycourses\\TY\\PSY310(L)\\word priming\\word_priming_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    for thisTrial_2 in trials_2:
        ...
        while continueRoutine and routineTimer.getTime() < 10.0:
            ...
            if textbox.status == STARTED:
                # is it time to stop? (based on global clock, using actual start)
                if tThisFlipGlobal > textbox.tStartRefresh + 10.0-frameTolerance:
                    # keep track of stop time/frame for later
