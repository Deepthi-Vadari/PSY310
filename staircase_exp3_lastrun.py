...
expName = 'staircase_exp3'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Srikanth Vadari\\Documents\\AU_mycourses\\TY\\PSY310(L)\\Adaptive_staircase\\staircase_exp3_lastrun.py',
