...
expName = 'visual search task'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Srikanth Vadari\\Documents\\AU_mycourses\\TY\\PSY310(L)\\visual_search_task\\visual search task_lastrun.py',
