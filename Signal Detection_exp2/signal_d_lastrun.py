...
expName = 'signal_d'  # from the Builder filename that created this script
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Srikanth Vadari\\Documents\\AU_mycourses\\TY\\PSY310(L)\\signal_detection\\signal_d_lastrun.py',
